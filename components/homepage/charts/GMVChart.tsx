    ...
    return (
        <ResponsiveContainer width="100%" height="100%" >
            ...
            >
                ...
                <Area type="monotone" stroke="#E9F2FE" dataKey="uv" fill="#EDF5FF" dot={false} opacity={1} />
                <Area type="monotone" stroke="none" dataKey="pv" fill="#006DE3" dot={false} opacity={0.5} />
            </AreaChart>
        </ResponsiveContainer>
    )
}
